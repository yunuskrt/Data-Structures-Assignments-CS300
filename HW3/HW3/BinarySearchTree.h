...
class BinaryNode
{
    ...
    public:
        ...
        void setElement(const Comparable & newElement){
            element = newElement;
        }
...
class BinarySearchTree
{
    ...
    public:
        ...
        void makeEmpty( );
        void insert( const Comparable & x, bool check );
        void remove( const Comparable & x );
        void update(const Comparable & x){
            find(x, root)->setElement(x);
        }
        const Comparable getNotFound() const{
...
BinarySearchTree<Comparable>::BinarySearchTree(const Comparable & notFound)
    :ITEM_NOT_FOUND( notFound ), root( NULL ), left(NULL), right(NULL){}
...
*/
template <class Comparable>
void BinarySearchTree<Comparable>::insert( const Comparable & x,bool check )
{
    insert( x, root );
}
